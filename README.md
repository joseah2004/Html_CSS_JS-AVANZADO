# Proyecto Frontend Avanzado - JS, HTML y CSS

Este proyecto forma parte de mi aprendizaje en **desarrollo web avanzado**, aplicando técnicas modernas de **JavaScript**, **HTML5** y **CSS3**.  
El objetivo es crear una aplicación interactiva que permita **cambiar entre ventanas/secciones dinámicas**, aplicar estilos avanzados y mejorar la experiencia de usuario.
...
- **JavaScript ES6+** (Funciones, Eventos, DOM, LocalStorage)  
...
- Uso de **LocalStorage** para guardar datos del usuario.
